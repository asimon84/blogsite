...
class ProjectsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Project::factory()->create([
            ...
            'image' => 'storage/images/project/accounts-payable.png',
        ...
        Project::factory()->create([
            ...
            'description' => '<p class="portfolio-text">Work in progress!</p><p class="portfolio-text">Implementing RAG architecture, LLM libraries, and AI/ML coding concepts to produce basic automation examples.</p>',
        ]);
    }
}
